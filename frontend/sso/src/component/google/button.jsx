    ...
    <>
      {!check ? (
        <button
          type="button"
          onClick={() => login()}
          className="flex items-center p-2 gap-1 text-sky-600 bg-white leading-tight rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 488 512"
            className="w-5 h-5 mr-1 text-[#4285F4]"
          >
            <path
              fill="currentColor"
          ...
          <p className="text-[#4285F4]">Continue with Google</p>
        </button>
      ) : (
